...
OXA_Palette <- c('OXA-23' = "#1F77B4", 
                 ...
                 'Other OXA' = "#2CA02C", 
                 "No OXA Genes" = "#7F7F7F")
PDS_Palette <- c("PDS000047378.12" = "#1F77B4",
                 "PDS000075026.16" = "#AEC7EB",
                 "PDS000083246.27" = "#FF7F0E",
                 "PDS000107407.4" = "#FFBB78",
                 "PDS000107408.3" = "#2CA02C",
                 "PDS000108570.17" = "#98DF8A",
                 "PDS000111517.2" = "#D62728",
                 "PDS000084878.14" = "#FF9896",
                 "PDS000112545.1" = "#9467BD",
                 "PDS000075027.18" = "#C5B0D5",
                 "PDS000094961.72" = "#8C564B",
                 "PDS000105896.15" = "#C49C94",
                 "PDS000098000.9" = "#E377C2",
                 "PDS000104873.2" = "#F7B6D2",
                 "PDS000112895.20" = "#17BECF",
                 "PDS000104060.1" = "#9EDAE5",
                 "PDS000120625.1" = "#BCBD22",
...
bar2
```
OXA-72 is an OXA-24 like gene. For PCR testing both genes will result as OXA-24 positive.  For this report they have been divided up to show the occurrence of each gene in the state of Virginia.  There have been no cases of OXA-58 or OXA-235 identified in the state of Virginia to date.
...
map
```
Gray districts have no CRAB submissions.
...
```
Gray districts have no OXA-23 genes identified.
...
ggplot(merged_HD) + 
  ...
  coord_sf(xlim = c (-84, -75), ylim = c(35, 40))
```
Gray districts have no OXA-24 genes identified.
...
ggplot(merged_HD) + 
  ...
  coord_sf(xlim = c (-84, -75), ylim = c(35, 40))
```
Gray districts have no OXA-72 genes identified.
